var newBuildScenario = {
    ...
    "/pa/units/structure/bug_wall/bug_wall.json": ["bug_utility", 14, {row: 2, column: 4}],
    ...
    "/pa/units/structure/bug_turret_acid/bug_turret_acid.json": ["bug_combat", 6, {row: 2, column: 2}],
    ...
    "/pa/units/research/unlocks/bug_hydra_unlock/bug_hydra_unlock.json":["bug_adv_research",2,{row:2,column:1}],
